...
//		out << YAML::BeginMap; 
//		{
//			out << YAML::KeyEvent << "ID" << YAML::Value << 11111111111;
//			out << YAML::KeyEvent << "Components" << YAML::Value;
//			out << YAML::BeginMap; 
//			{
//				if (entity.HasComponent<TagComponent>())
//				{
//					auto com = entity.GetComponent<TagComponent>();
//					out << YAML::KeyEvent << "TagComponent" << YAML::Value;
//					out << YAML::BeginMap; 
//					{
//						out << YAML::KeyEvent << "Tag" << YAML::Value << com->Tag; 
//					}
//					out << YAML::EndMap;
//				}
//
...
//					out << YAML::KeyEvent << "SpriteComponent" << YAML::Value;
//					out << YAML::BeginMap; 
//					{
//						out << YAML::KeyEvent << "Color" << YAML::Value<<com->Color;
//					}
//					out << YAML::EndMap;
//				}
//
...
//					out << YAML::KeyEvent << "TransformComponent" << YAML::Value;
//					out << YAML::BeginMap; 
//					{
//						out << YAML::KeyEvent << "Location" << YAML::Value<< com->Location;
//
//						out << YAML::KeyEvent << "Rotation" << YAML::Value<< com->Rotation;
//
//						out << YAML::KeyEvent << "Scale" << YAML::Value<< com->Scale;
//					}
//					out << YAML::EndMap;
//				}
//			}
...
//	}
//
//	void Serializer::Serialize(const SPtr<World>& scene)
//	{
...
//		out << YAML::BeginMap;
//		{
//			out << YAML::KeyEvent << "Scene" << YAML::Value << scene->m_Name;
//			out << YAML::KeyEvent << "Entities" << YAML::Value;
//			out << YAML::BeginSeq;
//			{
...
//	}
//
//	SPtr<World> Serializer::DeSerialize(const std::filesystem::path& filepath)
//	{
//		YAML::Node node = YAML::LoadFile(filepath.string());
//		if (!node["Scene"])return nullptr;
//		SPtr<World>scene = CreateSPtr_Raw<World>(new World());
